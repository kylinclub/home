			...
			<div class="col-lg-6">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form action="/admin/speaker_import" class="form-horizontal m-t" id="commentForm" enctype="multipart/form-data" method="post">
			...
			<div class="col-lg-6">
				<div class="alert alert-warning">
					...
					<ol class="tips">
						...
						<li>2.会完全覆盖原有数据</li>
						<li>3.<a href="/xls/speaker.xls">点击下载</a>模板</li>
					</ol>
					<!--  <span class="alert-link" style="font-size: 20px;padding-left:25px;">模板文件字段说明如下：</span>
					<br>
					<ol class="tips">
						<li>1.要确保每个演讲嘉宾的序号是唯一不变的</li>
						<li>2.“会场”列请填写数字，对应关系为：1对应主会场，2对应云专场，3对应运维专场，4对应大数据专场，5对应技术&产品专场</li>
					</ol>-->
				</div>
			</div>
		</div>
