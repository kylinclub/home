			...
			<ul class="nav" id="side-menu">
				...
				<li id="confrence">
					...
					<ul class="nav nav-second-level collapse">
						...
						<li id="guest1">
							<a href="/admin/guest_list?type=1">大会主席团管理</a>
						</li>
						<li id="guest0">
							<a href="/admin/guest_list?type=0">专家顾问团管理</a>
						</li>
						<li id="speaker">
							<a href="/admin/speaker_list">演讲嘉宾管理</a>
						</li>
						<li id="opt">
							<a href="/admin/banner_list">首页滚动图片管理</a>
						</li>
					</ul>
				</li>
				<li id="sh">
					...
					<ul class="nav nav-second-level collapse">
						<li id="user0">
							<a href="/admin/user_list?type=0">特邀嘉宾管理</a>
						</li>
						<li id="user1">
							<a href="/admin/user_list?type=1">演讲嘉宾管理</a>
						</li>
					</ul>
				</li>
			</ul>
